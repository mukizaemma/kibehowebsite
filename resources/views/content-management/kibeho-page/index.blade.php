        ...
        <div class="bg-light rounded h-100 p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted small mb-0">Manage the public Explore Kibeho Sanctuary page — content, gallery, and events.</p>
                </div>
            ...
            <ul class="nav nav-tabs mb-4" id="kibehoPageTabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="kibeho-tab-events" data-bs-toggle="tab" data-bs-target="#kibeho-panel-events" type="button" role="tab">Events</button>
                </li>
            </ul>
            ...
            <div class="tab-content" id="kibehoPageTabContent">
                        ...
                        <div class="row g-4">
                            <div class="col-lg-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="kibeho_description" name="description" rows="8">{{ $page->description }}</textarea>
                                </div>
                                <div class="mb-3">
                ...
                <div class="tab-pane fade" id="kibeho-panel-events" role="tabpanel">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h5 class="mb-0">Sanctuary events</h5>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="kibehoEventModalTitle">Add event</h5>
...
function resetKibehoEventForm() {
    ...
    document.getElementById('kibehoEventModalTitle').textContent = 'Add event';
...
function editKibehoEvent(id) {
    fetch(`${kibehoEventBase}/${id}`)
        ...
        .then(data => {
            ...
            document.getElementById('kibehoEventModalTitle').textContent = 'Edit event';
...
@if($page->description)
$(function() { $('#kibeho_description').summernote({ height: 220 }); $('#kibeho_description').summernote('code', @json($page->description)); });
@else
$(function() { $('#kibeho_description').summernote({ height: 220 }); });
@endif
</script>
@endsection
